...
Object.getPrototypeOf || (Object.getPrototypeOf = function(t) {
    ...
    function(t) {
        ...
        A.prototype = ht, n(ht, "next", function() {
            ...
            if (r >= e.length) return o(t, "[[StringIteratorNextIndex]]", Infinity), T(C, !0);
            var n = e.codePointAt(r);
            return o(t, "[[StringIteratorNextIndex]]", r + (n > 65535 ? 2 : 1)), T(String.fromCodePoint(n), !1)
            ...
            var E = s(t),
                T = f(E.length);
            for (c = p(o) ? new o(T) : new Array(T), y = 0; y < T;) {
                var O = E[y];
                b = i ? r.call(a, O, y) : O, c[y] = b, y += 1
            }
            return c.length = T, c
        }), n(Array, "of", function() {
            var t, r = arguments,
        ...
        D.prototype = vt, n(vt, "next", function() {
                var t = e(this);
                if ("object" !== a(t)) throw TypeError();
                ...
                if (u >= f) return o(t, "[[ArrayIteratorNextIndex]]", Infinity), T(C, !0);
                if (r = u, o(t, "[[ArrayIteratorNextIndex]]", u + 1), -1 !== s.indexOf("value") && (n = i[r]), -1 !== s.indexOf("key+value")) return T([r, n], !1);
                if (-1 !== s.indexOf("key")) return T(r, !1);
                if ("value" === s) return T(n, !1);
                ...
                if (r in t) {
                    ...
                    n(o, "from", function(t) {
                        ...
                        var j = s(t);
                        for (b = new o(m = f(j.length)), E = 0; E < m;) T = j[E], O = i ? r.call(a, T, E) : T, b[E] = O, ++E;
                        return b
                    }), n(o, "of", function() {
            ...
            function() {
                ...
                u.prototype = p, n(p, "next", function() {
                    ...
                    for (var r = t["[[Map]]"], n = t["[[MapNextIndex]]"], i = t["[[MapIterationKind]]"], u = r["[[MapData]]"]; n < u.keys.length;) {
                        ...
                        if (n = n += 1, o(t, "[[MapNextIndex]]", n), c.key !== nt) return "key" === i ? T(c.key, !1) : "value" === i ? T(c.value, !1) : T([c.key, c.value], !1)
                    }
                    return T(C, !0)
                }), n(p, ft, "Map Iterator")
            }(),
            function() {
                ...
                u.prototype = p, n(p, "next", function() {
                    ...
                    for (var r = t["[[IteratedSet]]"], n = t["[[SetNextIndex]]"], i = t["[[SetIterationKind]]"], u = r["[[SetData]]"]; n < u.length;) {
                        var c = u[n];
                        if (n = n += 1, o(t, "[[SetNextIndex]]", n), c !== nt) return "key+value" === i ? T([c, c], !1) : T(c, !1)
                    }
                    return T(C, !0)
                }), n(p, ft, "Set Iterator")
            }(),
            ...
            function() {
                ...
                function u() {
                    var t = function(e) {
                        ...
                        return l(u) ? (O("PromiseJobs", b, [r, e, u]), C) : c(r, e)
                    };
                    return t
                }
                ...
                function d(t, e) {
                    for (var r = 0, n = t.length; r < n; ++r) O("PromiseJobs", m, [t[r], e]);
                    return C
                }
                ...
                function E(t) {
                    ...
                    if (!l(t)) throw TypeError();
                    return o(r, "[[PromiseConstructor]]", E), T(r, t)
                }
                ...
                n(E, "all", function(t) {
                    ...
                    return "pending" === r["[[PromiseState]]"] ? (r["[[PromiseFulfillReactions]]"].push(o), r["[[PromiseRejectReactions]]"].push(i)) : "fulfilled" === r["[[PromiseState]]"] ? O("PromiseJobs", m, [o, r["[[PromiseResult]]"]]) : "rejected" === r["[[PromiseState]]"] && O("PromiseJobs", m, [i, r["[[PromiseResult]]"]]), n["[[Promise]]"]
        ...
        if ("window" in t && "document" in t) {
                ...
                function() {
                    function r(t, e) {
                        ...
                        if (Object.defineProperties(this, {
                                ...
                                contains: {
                                    value: function(n) {
                                        return n = String(n), -1 !== r(t[e]).indexOf(n)
                                    }
                                },
                                add: {
                                    value: function() {
            ...
            var o = {
                prepend: function() {
                    ...
                    t = n(t), this.insertBefore(t, this.firstChild)
                },
                append: function() {
                    var t = [].slice.call(arguments);
                    t = n(t), this.appendChild(t)
                }
            };
            r(t.Document || t.HTMLDocument, o), r(t.DocumentFragment, o), r(t.Element, o), "firstElementChild" in document.documentElement || e("firstElementChild", function() {
                ...
                for (var t = 0, e = this.children, r = 0, n = e.length; r < n; ++r) e[r].nodeType === Node.ELEMENT_NODE && ++t;
                return t
            });
            var i = {
                before: function() {
                    var t = [].slice.call(arguments),
                        e = this.parentNode;
                    if (e) {
                        for (var r = this.previousSibling; - 1 !== t.indexOf(r);) r = r.previousSibling;
                        var o = n(t);
                ...
                after: function() {
                    var t = [].slice.call(arguments),
                        e = this.parentNode;
                    if (e) {
                        for (var r = this.nextSibling; - 1 !== t.indexOf(r);) r = r.nextSibling;
                        var o = n(t);
                        e.insertBefore(o, r)
                    }
                },
            ...
            r(t.DocumentType, i), r(t.Element, i), r(t.CharacterData, i)
        }
    }(self),
    function(t) {
        "use strict";
